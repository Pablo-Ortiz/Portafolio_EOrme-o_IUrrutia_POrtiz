...
from tienda.views import agregar_producto, eliminar_producto, restar_producto, limpiar_carrito, sumar_producto ,registro, guardar
...
urlpatterns = [
    ...
    path('guardar/', guardar, name="Save"),
]
